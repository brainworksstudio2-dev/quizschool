    ...
    <main className="min-h-svh w-full grid grid-cols-1 lg:grid-cols-2">
       <div className="relative hidden lg:block">
        ...
        <div className="absolute bottom-8 left-8 text-white">
            <h2 className="text-3xl font-bold">Join a community of learners</h2>
            <p className="max-w-md mt-2">Take on new challenges, track your progress, and achieve your goals with QuizWhiz.</p>
        </div>
      </div>
